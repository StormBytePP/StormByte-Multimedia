...
Video::Video(class Color color, class Resolution resolution, std::optional<class HDR10> hdr10) noexcept:
m_color(std::move(color)), m_resolution(std::move(resolution)), m_hdr10(std::move(hdr10)) {}
