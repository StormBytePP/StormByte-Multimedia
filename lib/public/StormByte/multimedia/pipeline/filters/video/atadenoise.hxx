...
namespace StormByte::Multimedia::Pipeline::Filter::Video {
	...
	class STORMBYTE_MULTIMEDIA_PUBLIC Atadenoise: public Filter::Process {
		public:
			/**
			 * @brief ATA denoise (`atadenoise`).
			 * @param log Shared logger. Empty pointer means no log.
			 * @param frames Temporal window (odd). Empty → 9.
			 * @param lumaA Luma |centre| threshold. Empty → 0.02.
			 * @param lumaB Luma |step| threshold. Empty → 0.04.
			...
			/**
			 * @brief Pushes one video frame through `atadenoise` and Save.
