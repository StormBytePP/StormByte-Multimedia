...
#include <StormByte/multimedia/pipeline/filters/video/fftdnoiz.hxx>
...
using StormByte::Multimedia::Pipeline::Filter::Video::Fftdnoiz;
...
void Fftdnoiz::Clean() noexcept {
	m_graph.reset();
}

void Fftdnoiz::Setup() noexcept {
	Clean();
}
