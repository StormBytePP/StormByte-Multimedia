...
const StormByte::Multimedia::Features& Decoder::Features() const noexcept {
	return m_features;
}

StormByte::Multimedia::Features Decoder::DetectFeatures(const std::string_view& name) noexcept {
