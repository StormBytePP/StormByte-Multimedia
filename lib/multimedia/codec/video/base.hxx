...
/**
 * @namespace Video
 * @brief The namespace for all video codecs.
 */
namespace StormByte::Multimedia::Codec::Video {
	/**
	 * @class Base
	...
	class STORMBYTE_MULTIMEDIA_PUBLIC Base: public Codec::Base {
		public:
			...
			constexpr Base(const Name& name) noexcept:
				Codec::Base(name, Property::Type::Video) {}
			...
			constexpr Base(Name&& name) noexcept:
				Codec::Base(std::move(name), Property::Type::Video) {}
