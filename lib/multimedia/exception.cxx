...
CodecNotCompatible::CodecNotCompatible(const Codec::Name& codec, const std::string& container):
Exception("The codec " + Codec::NameToString(codec) + " is not compatible with " + container) {}
