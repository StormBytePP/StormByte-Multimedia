...
namespace {
	...
	void StampSubtitlePacket(StormByte::Multimedia::Backend::FFmpeg::AVPacket& pkt,
		std::int64_t pts, std::uint32_t durationMs, AVRational tb) noexcept {
...
bool Subtitle::Push(StormByte::Multimedia::Pipeline::Encoder& owner,
	...
	const std::int64_t pts = frame->Pts()
		? StormByte::Multimedia::Backend::Pipeline::Encoder::NsToTicks(startNs, AVRational{1, AV_TIME_BASE})
		: AV_NOPTS_VALUE;
