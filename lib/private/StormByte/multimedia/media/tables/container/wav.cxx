...
namespace {
	constexpr CompatDef table[] = {
		...
		{ nullptr,	"GSM Microsoft" },
		{ nullptr,	"MP3" },
		{ nullptr,	"PCM A-law" },
		{ nullptr,	"PCM F32 LE" },
		{ nullptr,	"PCM F64 LE" },
		{ nullptr,	"PCM S16 LE" },
		{ nullptr,	"PCM S16 LE Planar" },
		{ nullptr,	"PCM S24 LE" },
		{ nullptr,	"PCM S24 LE Planar" },
		{ nullptr,	"PCM S32 LE" },
		{ nullptr,	"PCM S32 LE Planar" },
		{ nullptr,	"PCM S8" },
		{ nullptr,	"PCM U8" },
		{ nullptr,	"PCM μ-law" },
	};
...
std::span<const CompatDef> StormByte::Multimedia::Media::Tables::Container::WAV() noexcept {
	return table;
}
