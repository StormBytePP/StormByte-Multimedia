...
const StormByte::Multimedia::Features& Encoder::Features() const noexcept {
	return m_features;
}

StormByte::Multimedia::Features Encoder::DetectFeatures(const std::string_view& name) noexcept {
	StormByte::Multimedia::Features features;
